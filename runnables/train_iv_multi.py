...
def main(args: DictConfig):
    ...
    multimodel = instantiate(args.model.ivt, args, dataset_collection, _recursive_=False)
    if args.model.ivt.tune_hparams:
        multimodel.finetune(resources_per_trial=args.model.ivt.resources_per_trial)
    ...
    multimodel_trainer = Trainer(gpus=eval(str(args.exp.gpus)), logger=mlf_logger, max_epochs=args.exp.max_epochs,
                                 ...
                                 gradient_clip_val=args.model.ivt.max_grad_norm)
